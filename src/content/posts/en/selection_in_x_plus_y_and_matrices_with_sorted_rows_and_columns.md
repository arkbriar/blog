---
title: "Kth Largest Element in a Sorted Matrix (Selection in X+Y or Sorted Matrices)"
tags: ["selection", "sorted-matrix", "paper"]
category: "Algorithm"
published: 2017-08-02T20:58:55+08:00
draft: false
---

Today while solving LeetCode problems, I came across this one: [Kth Smallest Element in a Sorted Matrix](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/description/).
...
However, while browsing the Discuss section, I discovered that there is actually an O(n) algorithm (where n is the number of rows/columns), from the paper [Selection in X + Y and Matrices with Sorted Rows and Columns](http://www.cse.yorku.ca/~andy/pubs/X+Y.pdf). It is also applicable to another problem, [Find k Pairs with Smallest Sums](https://leetcode.com/problems/find-k-pairs-with-smallest-sums/). I will only provide an overview here, because I don't think anyone could write this out during an interview...
